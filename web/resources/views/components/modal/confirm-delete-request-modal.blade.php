@props([
    'id' => 'confirm-delete-request-modal',
    'title' => __('app.data_deletion.modal_title'),
    'message' => __('app.data_deletion.modal_message'),
    'action' => '',
])
                ...
                <form method="POST" action="{{ $action }}">
                    ...
                    <div class="flex justify-end gap-2">
                        <button type="button"
                            ...
                            data-modal-hide="{{ $id }}">
                            {{ __('app.data_deletion.modal_cancel') }}
                        </button>
                        <button type="submit"
                            ...
                            {{ __('app.data_deletion.send_request') }}
                        </button>
                    </div>
                </form>
            </div>
...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const triggerButton = document.querySelector('[data-modal-target="{{ $id }}"]');
