...
return [
    ...
    'route'                          => [
         ...
         */
        'middleware' => [
            // X-API-KEY middleware - must be first
            Modules\Api\Http\Middleware\ApiKeyMiddleware::class,
    ...
    'schema_path'                    => base_path('Modules/Api/app/GraphQL/schema.graphql'),
    ...
    'namespaces'                     => [
        ...
        'types'         => 'Modules\\Api\\GraphQL\\Types',
        'interfaces'    => 'Modules\\Api\\GraphQL\\Interfaces',
        'unions'        => 'Modules\\Api\\GraphQL\\Unions',
        'scalars'       => 'Modules\\Api\\GraphQL\\Scalars',
        'directives'    => 'Modules\\Api\\GraphQL\\Directives',
        'validators'    => 'Modules\\Api\\GraphQL\\Validators',
        'resolvers'     => 'Modules\\Api\\GraphQL\\Resolvers',
    ],
    ...
    'security'                       => [
        'max_query_complexity'  => 0, // 0 means disabled
        'max_query_depth'       => 0, // 0 means disabled
        'disable_introspection' => env('LIGHTHOUSE_SECURITY_DISABLE_INTROSPECTION', false) ? 1 : 0,
    ],
    ...
    // Use the integer value instead of DebugFlag constants to avoid requiring the GraphQL DebugFlag class during config loading.
